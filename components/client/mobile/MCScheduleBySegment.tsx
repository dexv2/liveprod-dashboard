...
import { formatDateLong, formatDayShort } from "@/utils/helpers";
    ...
    <Fragment>
      <div className='w-full rounded-t-xl rounded-b-lg overflow-hidden'>
        <div className="w-full overflow-x-auto">
          <table className="table-auto w-full xl:min-w-0">
            <thead>
              <tr>
                <th colSpan={3} className="text-white bg-slate-800 border border-slate-800 uppercase py-2">
                  {formatDateLong(schedule.saturday)} ({formatDayShort(schedule.saturday)})
                </th>
              </tr>
              ...
              <tr className='uppercase bg-slate-300 border-t border-x border-slate-300 text-[10px] xl:text-sm'>
                ...
                <th className="px-0.5 xl:px-1 py-1"><span className="xl:hidden">5PM</span><span className="hidden xl:inline">Sat {saturday.FIRST_SERVICE}</span></th>
              </tr>
            </thead>
      ...
      <div className='w-full rounded-t-xl rounded-b-lg overflow-hidden'>
        <div className="w-full overflow-x-auto">
          <table className="table-auto w-full xl:min-w-0">
            <thead>
              <tr>
                <th colSpan={4} className="text-white bg-slate-800 border border-slate-800 uppercase py-2">
                  {formatDateLong(schedule.sunday)} ({formatDayShort(schedule.sunday)})
                </th>
              </tr>
            </thead>
            <tbody className='[&>tr.last-in-group]:border-b [&>tr.last-in-group]:border-b-black [&>tr.first-in-group]:border-t [&>tr.first-in-group]:border-t-black'>
